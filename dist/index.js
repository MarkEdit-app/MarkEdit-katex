 ...
 */
function findEndOfMath(closingDelim, text, startIndex) {
 ...
 */
function genericInlineMath(state, silent, openDelim, closeDelim, display) {
 ...
 */
function genericBlockMath(state, start, end, silent, openDelim, closeDelim) {
